...
public class ProdutoController {
    ...
    @Operation(summary = "Listar produto pelo id de produto", description = "Endpoint para obter produto pelo id de produto")
    ...
    @PostMapping("/criar")
    @Operation(summary = "Criar novo produto", description = "Endpoint para criar um novo registro de participante")
